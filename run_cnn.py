...
IMAGE_ROOT = '../../../../applications/PycharmProjects/pythonProject/data/256_ObjectCategories/256_ObjectCategories/'
def LOG_INFO(msg):
    now = datetime.now()
...
train_loader = DataLoader(
    MyDataset(IMAGE_ROOT, '../data_additional/train.txt', data_transforms['train']),
    batch_size=TRAIN_BATCH_SIZE, shuffle=True, **kwargs
)
test_loader = DataLoader(
    MyDataset(IMAGE_ROOT, '../data_additional/test.txt', data_transforms['val']),
